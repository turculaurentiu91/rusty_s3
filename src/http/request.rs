...
// TODO: replace with on demand processing or comparison on the headers module
...
//     }
// }
// TODO: replace with on demand processing module
...
pub fn parse_request(headers_buf: &'_ Vec<u8>) -> Option<std::io::Result<Request<'_>>> {
    ...
    let headers_buf = match std::str::from_utf8(&headers_buf[..body_start_pos])
